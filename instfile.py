...
directives = ["WORD", "BYTE", "RESW", "RESB", "START", "END", "BASE", 'A', 'X', 'L', 'B', 'S', 'T', 'F', 'ORG', 'EQU']
dirtoken   = ["WORD", "BYTE", "RESW", "RESB", "START", "END", "BASE", 'REG', 'REG', 'REG', 'REG', 'REG', 'REG', 'REG', 'ORG', 'EQU']
dircode  = [3, 1, 3, 1, 0, 0, 0, 0, 1, 2, 3, 4, 5, 6, 0, 0]
